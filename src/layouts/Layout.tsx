...
const Layout = () => {
  ...
  return (
    <>
      <Header />
      {isHomePage && <Hero />}
      <section className='w-full bg-whiteBase dark:bg-darkThemeBackground transition-colors duration-500 h-full pt-2.5 md:pt-7 pb-[60px] md:pb-[100px] lg:pb-[150px]'>
