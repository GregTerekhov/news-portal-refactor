...
const ArrowButtonPagination: FC<ArrowButtonProps> = ({
  ...
  return (
    <button
      ...
      className='group inline-flex items-center gap-x-2 rounded-full p-2.5 transition-colors duration-500 hover:bg-accentBase disabled:pointer-events-none disabled:opacity-50 dark:hover:bg-accentBase dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600'
    >
