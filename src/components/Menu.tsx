            ...
            {links.map((link) => (
              <li key={link.path}>
                <NavLink
                  ...
                  className={`relative pt-12 pb-8 lg:pt-[55px] lg:pb-[33px] hover:text-accentBase font-medium md:font-bold text-medium lg:text-xl hg:text-3xl md:text-medium transition-colors duration-500 ${
                    link.activeLink
